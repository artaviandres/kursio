...
import { getUserSignUp } from '../../store/actions/user';
import STYLES from '../../styles/variables.scss';
import 'react-toastify/dist/ReactToastify.css';

function SignUpModal({ setCaptchaValidationStatus, getUserSignupFunc, captchaValidation }) {
  ...
  return (
    <form
      ...
      <Input label="Name" placeholder="Andres" type="text" onChange={(e) => setName(e.target.value)} required />
      <Input label="Last Name" placeholder="Artavia" type="text" onChange={(e) => setLastName(e.target.value)} required />
      <Input label="Email" placeholder="aartavia@example.com" type="email" onChange={(e) => setEmail(e.target.value)} required />
      <Input label="Username" placeholder="artaviandres" type="text" onChange={(e) => setUsername(e.target.value)} required />
      <Input label="Password" placeholder="Set password" type="password" onChange={(e) => setPassword(e.target.value)} required />
